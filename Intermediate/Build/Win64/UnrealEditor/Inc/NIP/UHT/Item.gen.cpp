...
// Begin Delegate FOnItemRotation
struct Z_Construct_UDelegateFunction_NIP_OnItemRotation__DelegateSignature_Statics
{
#if WITH_METADATA
...
const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_NIP_OnItemRotation__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_NIP, nullptr, "OnItemRotation__DelegateSignature", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_NIP_OnItemRotation__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_NIP_OnItemRotation__DelegateSignature_Statics::Function_MetaDataParams) };
UFunction* Z_Construct_UDelegateFunction_NIP_OnItemRotation__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_NIP_OnItemRotation__DelegateSignature_Statics::FuncParams);
	}
	return ReturnFunction;
}
void FOnItemRotation_DelegateWrapper(const FMulticastScriptDelegate& OnItemRotation)
{
	OnItemRotation.ProcessMulticastDelegate<UObject>(NULL);
}
// End Delegate FOnItemRotation
