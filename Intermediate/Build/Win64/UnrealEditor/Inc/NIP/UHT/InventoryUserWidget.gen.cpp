...
// Begin Class UInventoryUserWidget Function InitializeInventory
struct Z_Construct_UFunction_UInventoryUserWidget_InitializeInventory_Statics
{
	struct InventoryUserWidget_eventInitializeInventory_Parms
	{
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UInventoryUserWidget_InitializeInventory_Statics::NewProp_NewInventory = { "NewInventory", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(InventoryUserWidget_eventInitializeInventory_Parms, NewInventory), Z_Construct_UClass_UInventory_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UInventoryUserWidget_InitializeInventory_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UInventoryUserWidget_InitializeInventory_Statics::NewProp_NewInventory,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UInventoryUserWidget_InitializeInventory_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UInventoryUserWidget_InitializeInventory_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UInventoryUserWidget, nullptr, "InitializeInventory", nullptr, nullptr, Z_Construct_UFunction_UInventoryUserWidget_InitializeInventory_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UInventoryUserWidget_InitializeInventory_Statics::PropPointers), sizeof(Z_Construct_UFunction_UInventoryUserWidget_InitializeInventory_Statics::InventoryUserWidget_eventInitializeInventory_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UInventoryUserWidget_InitializeInventory_Statics::Function_MetaDataParams), Z_Construct_UFunction_UInventoryUserWidget_InitializeInventory_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UInventoryUserWidget_InitializeInventory_Statics::InventoryUserWidget_eventInitializeInventory_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UInventoryUserWidget_InitializeInventory()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UInventoryUserWidget_InitializeInventory_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UInventoryUserWidget::execInitializeInventory)
{
	P_GET_OBJECT(UInventory,Z_Param_NewInventory);
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->InitializeInventory(Z_Param_NewInventory);
	P_NATIVE_END;
}
...
struct Z_Construct_UClass_UInventoryUserWidget_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_DragDropOperation_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Data" },
		{ "ModuleRelativePath", "InventoryUserWidget.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_DragMouseScreenPosition_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Data" },
		{ "ModuleRelativePath", "InventoryUserWidget.h" },
	};
	...
	static const UECodeGen_Private::FStructPropertyParams NewProp_DragMouseScreenPosition;
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UInventoryUserWidget_Statics::NewProp_DragDropOperation = { "DragDropOperation", nullptr, (EPropertyFlags)0x0020080000020015, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UInventoryUserWidget, DragDropOperation), Z_Construct_UClass_UDragDropOperation_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DragDropOperation_MetaData), NewProp_DragDropOperation_MetaData) };
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UInventoryUserWidget_Statics::NewProp_DragMouseScreenPosition = { "DragMouseScreenPosition", nullptr, (EPropertyFlags)0x0020080000020015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UInventoryUserWidget, DragMouseScreenPosition), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DragMouseScreenPosition_MetaData), NewProp_DragMouseScreenPosition_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UInventoryUserWidget_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UInventoryUserWidget_Statics::NewProp_DragDropOperation,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UInventoryUserWidget_Statics::NewProp_DragMouseScreenPosition,
...
struct Z_CompiledInDeferFile_FID_Users_Stas_Documents_Unreal_Projects_NIP_Source_NIP_InventoryUserWidget_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UInventoryUserWidget, UInventoryUserWidget::StaticClass, TEXT("UInventoryUserWidget"), &Z_Registration_Info_UClass_UInventoryUserWidget, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInventoryUserWidget), 3327080489U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Stas_Documents_Unreal_Projects_NIP_Source_NIP_InventoryUserWidget_h_3007123346(TEXT("/Script/NIP"),
